...
public class MySqlStudentDao extends AbstractJDBCDAO<Student, Integer> {
	...
	@Override
	protected List<Student> parseResSet(ResultSet rs) throws PersistException {
	...
	@Override
	protected void prepareStForUpdateSetArgs(PreparedStatement statement, Student object) throws PersistException {
		try {
